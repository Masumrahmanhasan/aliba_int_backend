        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview"
                ...
                <li
                    ...
                    <a href="#"
                        class="nav-link {{ active_class(Route::is('admin.order.*') || Route::is('admin.invoice.*')) }}">
                ...
                <li
                    class="nav-item has-treeview {{ active_class(active_class(Route::is('admin.accounts.*')), 'menu-open') }}">
                ...
                <li
                    class="nav-item has-treeview {{ active_class(active_class(Route::is('admin.coupon.*')), 'menu-open') }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.page.index') }}"
                        class="nav-link {{ active_class(Route::is('admin.page*')) }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.faq.index') }}"
                        class="nav-link {{ active_class(Route::is('admin.faq*')) }}">
                ...
                <li class="nav-item has-treeview {{ active_class($frontendActive, 'menu-open') }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.product-category-shipping-rate.index') }}"
                                class="nav-link {{ active_class(Route::is('admin.product-category-shipping-rate.*')) }}">
                                <i class="nav-icon fa fa-bullhorn"></i>
                                <p class="text">Product Category Shipping Rate</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                @if ($logged_in_user->isAdmin())
                    ...
                    <li
                        class="nav-item has-treeview {{ active_class(request()->is('admin/log-viewer*'), 'menu-open') }}">
